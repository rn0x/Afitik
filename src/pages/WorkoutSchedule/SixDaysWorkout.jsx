...
export default function SixDaysWorkout() {
  ...
  const pageMetadata = {
    ...
    description: "استعرض جدول تمارين مخصص لـ ستة أيام في الأسبوع يشمل تمارين متنوعة مع تفاصيل حول كل تمرين، العضلات المستهدفة، وعدد الجلسات والتكرارات. خطط لياقتك البدنية مع تطبيق عافيتك.",
    keywords: "جدول تمارين 6 أيام, خطة التمرين, تمارين رياضية, لياقة بدنية, تطبيق عافيتك",
  ...
  const schedule = [
    ...
    },
    {
      ...
      details: [
        ...
        {
          muscle: "الأرداف",
          exercise: "تمرين الجسر (Glute Bridges)",
          video: "https://www.youtube.com/watch?v=cruqsnAyU6A",
          sets: 3,
          reps: 15,
        },
      ],
    ...
    },
    {
      ...
      details: [
        ...
        {
          muscle: "البطن",
          exercise: "تمرين الرفع الأمامي (Leg Raises)",
        ...
        {
          muscle: "البطن",
          exercise: "تمرين الرفع الجانبي (Side Crunches)",
          video: "https://www.youtube.com/watch?v=rkYulzvBHJk",
          sets: 3,
          reps: 20,
        },
      ],
